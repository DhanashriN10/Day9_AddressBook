...
{
			 static ArrayList<Add_Contact> contactList = new ArrayList<>();
			 ...
			 public static void getcontacts()
			 {
			        ...
			        person.setMobileNumber(input.nextLong());
			 ...
			 public static void editcontacts()
			 {
		        ...
		        System.out.println("Enter mobile number: ");
		        contactList.get(index).setMobileNumber((input.nextLong()));
			 ...
			 public static void display()
			 {
				 ...
				 for  (int i = 0 ; i < contactList.size(); i ++ )
				 {
					 ...
					 System.out.println("PHONE NUMBER : "+contactList.get(i).getMobileNumber());
